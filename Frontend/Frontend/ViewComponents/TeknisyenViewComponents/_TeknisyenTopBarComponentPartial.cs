...
public class _TeknisyenTopBarComponentPartial : ViewComponent
{
    ...
    public _TeknisyenTopBarComponentPartial(IHttpClientFactory httpClientFactory)  
    {
    ...
    public async Task<IViewComponentResult> InvokeAsync(string id)
    {
        ...
        var response = await client.GetAsync($"https://testapi.solfix.help:444/api/User/GetUserById/{id}");
